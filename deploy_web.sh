...
# Separate from VERTEX_AI_LOCATION (this service's own --region): the Agent Runtime
# resource lives wherever agents-cli deployed it, currently us-east1 regardless of
# VERTEX_AI_LOCATION.
AGENT_RUNTIME_LOCATION="${AGENT_RUNTIME_LOCATION:-us-east1}"
...
ENV_VARS="${ENV_VARS},AGENT_RUNTIME_LOCATION=${AGENT_RUNTIME_LOCATION}"
